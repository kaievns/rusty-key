...
pub const QWERTY: Layout = Layout { template: "
  ~ ! @ # $ % ^ & * ( ) _ +
  ` 1 2 3 4 5 6 7 8 9 0 - =
    Q W E R T Y U I O P { } |
    q w e r t y u i o p [ ] \\
...
pub const DVORAK: Layout = Layout { template: "
  ~ ! @ # $ % ^ & * ( ) { } 
  ` 1 2 3 4 5 6 7 8 9 0 [ ]
   \" < > P Y F G C R L ? + |
    ' , . p y f g c r l / = \\
...
pub const COLEMAK: Layout = Layout { template: "
  ~ ! @ # $ % ^ & * ( ) _ +
  ` 1 2 3 4 5 6 7 8 9 0 - =
    Q W F P G J L U Y : { } |
    q w f p g j l u y ; [ ] \\
...
pub const WORKMAN: Layout = Layout { template: "
  ~ ! @ # $ % ^ & * ( ) _ +
  ` 1 2 3 4 5 6 7 8 9 0 - =
    Q D R W B J F U P : { } |
    q d r w b j f u p ; [ ] \\
...
pub const THE_1: Layout = Layout { template: "
  ~ | @ # $ % ^ & * ( ) _ +
  ` 1 2 3 4 5 6 7 8 9 0 - =
    K M L U ! V D R \" Q { } <
    k m l u ? v d r ' q [ ] >
...
pub const HALMAK_21: Layout = Layout { template: "
  ~ ! @ # $ % ^ & * < > _ +
  ` 1 2 3 4 5 6 7 8 9 0 - =
    W L R B Z : Q U D J { } |
    w l r b z ; q u d j [ ] \\
